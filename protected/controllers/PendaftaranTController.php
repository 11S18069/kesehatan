...
class PendaftaranTController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('PendaftaranT');
	...
	{
		$model=new PendaftaranT('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['PendaftaranT']))
			$model->attributes=$_GET['PendaftaranT'];
	 ...
	 * @param PendaftaranT $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='pendaftaran-t-form')
		{
